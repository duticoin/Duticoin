...
const QString BITCOIN_IPC_PREFIX("duticoin:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/duticoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/duticoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/duticoin-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click duticoin: links
...
//
// OSX-specific way of handling duticoin: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in duticoin: URIs
