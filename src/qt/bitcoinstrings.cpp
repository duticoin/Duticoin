...
QT_TRANSLATE_NOOP("bitcoin-core", "Imports blocks from external dtc000??.dat file on startup"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Rebuild chain state and block index from the dtc*.dat files on disk"),
