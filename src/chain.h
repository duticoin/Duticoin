...
enum BlockStatus: uint32_t {
    ...
    BLOCK_HAVE_DATA          =    8, //!< full block available in dtc*.dat
...
public:
    ...
    //! Which # file this block is stored in (dtc?????.dat)
    int nFile;

    //! Byte offset within dtc?????.dat where this block's data is stored
