...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"duticoinaddress\"\n"
            "\nReveals the private key corresponding to 'duticoinaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"duticoinaddress\"   (string, required) The duticoin address for the private key\n"
            "\nResult:\n"
