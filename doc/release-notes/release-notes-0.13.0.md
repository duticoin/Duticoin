...
- #7993 `6a034ed` [depends] Bump Fdtcype, ccache, ZeroMQ, miniupnpc, expat (fanquake)
...
- #7680 `41d2dfa` Remove duticoinion from `about` icon (laanwj)
...
- #7662 `386f438` remove unused NODTCS_VERSION_{START,END} constants (rat4)
