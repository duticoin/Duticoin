...
These are the dependencies currently used by Duticoin Core. You can find instructions for installing them in the `build-*.md` file for your platform.
...
| FreeType | [2.7.1](https://download.savannah.gnu.org/releases/fdtcype) |  | No |  |  |
...
Telegram - https://t.me/duticoinnl
Keybase  - https://keybase.io/team/duticoin/
