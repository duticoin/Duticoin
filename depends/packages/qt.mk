...
$(package)_linux_dependencies=fdtcype fontconfig libxcb libxkbcommon libX11 xproto libXext
...
$(package)_config_opts += -no-fdtcype
...
$(package)_config_opts_linux += -system-fdtcype
